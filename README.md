...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-v3arp2c.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-v3arp2c.containers.anotherwebservice.com/
...
```
git clone git@github.com:tekvecko/container-v3arp2c.git
cd container-v3arp2c
```
...
```
docker attach container-v3arp2c
```
